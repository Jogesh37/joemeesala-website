  ...
  return (
    <section id="articles" className="py-16 bg-white">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <p className="text-center text-lg mb-8">Please sign-up below for Articles</p>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          <form className="space-y-4">
            ...
            <div className="flex items-start mt-4">
              <input type="checkbox" className="mt-1" id="articles" />
              <label htmlFor="articles" className="ml-2 text-sm text-gray-600">
                I agree to receive article updates and publications
              </label>
            </div>

  ...
  return (
    <section id="blogs" className="py-16 bg-white">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <p className="text-center text-lg mb-8">Please sign-up below for Blogs</p>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          <form className="space-y-4">
            ...
            <div className="flex items-start mt-4">
              <input type="checkbox" className="mt-1" id="blogs" />
              <label htmlFor="blogs" className="ml-2 text-sm text-gray-600">
                I agree to receive blog updates and notifications
              </label>
            </div>
